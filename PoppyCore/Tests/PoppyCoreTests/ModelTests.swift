...
struct StoreDataTests {
    ...
    func decodeFixture() throws {
        let fixtureURL = Bundle.module.url(forResource: "sample_store", withExtension: "json", subdirectory: "Fixtures")
            ?? Bundle.module.url(forResource: "sample_store", withExtension: "json")
            ?? Bundle.allBundles.lazy.compactMap {
                $0.url(forResource: "sample_store", withExtension: "json")
            }.first
