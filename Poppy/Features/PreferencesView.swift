                ...
                Section("Behavior") {
                    HStack(alignment: .center, spacing: 8) {
                        ...
                        VStack(alignment: .leading, spacing: 2) {
                            Text("Open on Login")
                            Text("Start Poppy when you log in to your Mac").settingsCaption()
                        }
                        Spacer()
                        Toggle("", isOn: Binding(
                            get: { launchAtLogin },
                    ...
                    HStack(alignment: .center, spacing: 8) {
                        ...
                        VStack(alignment: .leading, spacing: 2) {
                            Text("Show Dock Icon")
                            Text("Show Poppy in the Dock and Cmd+Tab switcher").settingsCaption()
                        }
                        Spacer()
                        Toggle("", isOn: Binding(
                    ...
                    HStack(alignment: .center, spacing: 8) {
                        ...
                        VStack(alignment: .leading, spacing: 2) {
                            ...
                            Text("Open the settings window when Poppy starts").settingsCaption()
                        }
                        Spacer()
                ...
                Section("Permissions") {
                    permissionRow(
                        ...
                        detail: permissionStatus.accessibility
                            ...
                            : "Required for global hotkey (⌘⇧K). Toggle Poppy on in System Settings.",
                    ...
                    permissionRow(
                        ...
                        detail: permissionStatus.fullDiskAccess
                            ...
                            : "Click Open, add the revealed Poppy app with +, then toggle it on",
